...
public class SocketTestUtilities {
    ...
    public static void measureLatency(OutputStream os, DataInputStream is, byte[] buffer, int cycles, boolean measure) throws IOException, InterruptedException {
        ...
        for (int cycle = 0; cycle < cycles;) {
            ...
            while (counter++ < TestServerSocketFactory.LatencyServerSocket.NUM_MESSAGES) {
                for (int i = 0; i < TestServerSocketFactory.LatencyServerSocket.NUM_PER_BURST; i++) {
    ...
    public static void proccessLatencyRequests(DataOutputStream os, DataInputStream is, byte[] buffer, boolean measure) {
        int count = 0;
        int TOTAL = TestServerSocketFactory.LatencyServerSocket.NUM_MESSAGES * TestServerSocketFactory.LatencyServerSocket.NUM_PER_BURST;
...
//                    }
                ...
                if (count % TestServerSocketFactory.LatencyServerSocket.NUM_MESSAGES * TestServerSocketFactory.LatencyServerSocket.NUM_PER_BURST == 0) {
