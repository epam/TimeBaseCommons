...
public class KeystoreConfig {
    ...
    public static KeystoreConfig.Builder builder() {
    ...
    public class Builder {
         ...
         * @return the builder
         */
        public KeystoreConfig.Builder withPkcs12(String location, String alias, String password) {
         ...
         * @return the builder
         */
        public KeystoreConfig.Builder withJks(String location, String alias, String password) {
         ...
         * @return the builder
         */
        public KeystoreConfig.Builder withPemFiles(String pemKeyLocation, String pemCertLocation) {
         ...
         * @return the builder
         */
        public KeystoreConfig.Builder withPem(String pemKey, String pemCert) {
            KeystoreConfig.this.type = KeystoreType.PEM;
