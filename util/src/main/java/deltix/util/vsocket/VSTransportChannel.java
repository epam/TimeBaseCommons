...
import static deltix.util.vsocket.VSProtocol.BYTES_AVAILABLE_REPORT;
import static deltix.util.vsocket.VSProtocol.BYTES_RECIEVED;
import static deltix.util.vsocket.VSProtocol.CLOSED;
import static deltix.util.vsocket.VSProtocol.CLOSING;
import static deltix.util.vsocket.VSProtocol.CONNECT_ACK;
import static deltix.util.vsocket.VSProtocol.DISPATCHER_CLOSE;
import static deltix.util.vsocket.VSProtocol.KEEP_ALIVE;
import static deltix.util.vsocket.VSProtocol.LISTENER_ID;
import static deltix.util.vsocket.VSProtocol.LOGGER;
import static deltix.util.vsocket.VSProtocol.PING;
