...
public class Oauth2ClientConfig {
    ...
    public static Oauth2ClientConfig.Builder builder() {
    ...
    public class Builder {
        ...
        public Oauth2ClientConfig.Builder withUrl(String url) {
        ...
        public Oauth2ClientConfig.Builder withKeystoreConfig(KeystoreConfig keystoreConfig) {
            Oauth2ClientConfig.this.keystoreConfig = keystoreConfig;
            return this;
        }

        public Oauth2ClientConfig.Builder withParameter(String name, String value) {
            Oauth2ClientConfig.this.parameters.put(name, value);
            return this;
        }

        public Oauth2ClientConfig.Builder withTimer(Timer timer) {
        ...
        public Oauth2ClientConfig.Builder withTimeout(long timeoutMs) {
            Oauth2ClientConfig.this.timeoutMs = timeoutMs;
            return this;
        }

        public Oauth2ClientConfig.Builder withConnectTimeout(int connectTimeoutMs) {
            Oauth2ClientConfig.this.connectTimeoutMs = connectTimeoutMs;
            return this;
        }

        public Oauth2ClientConfig.Builder withReadTimeout(int readTimeoutMs) {
            Oauth2ClientConfig.this.readTimeoutMs = readTimeoutMs;
            return this;
        }

        public Oauth2ClientConfig.Builder withExpirationMultiplier(double multiplier) {
