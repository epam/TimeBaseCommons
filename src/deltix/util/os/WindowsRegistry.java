...
public class WindowsRegistry {
    ...
    public static String getKeySz ( int hive,
                                    String keyName,
                                    String valueName )
        ...
        try {
            ...
            int[] result = (int[]) openKeyMethod.invoke ( null,
                                                          hive,
                                                          stringToByteArray ( keyName ),
                                                          KEY_READ );
            ...
            byte[] b = (byte[]) queryValueMethod.invoke ( null,
                                                          hKey,
                                                          stringToByteArray ( valueName ) );
            closeKeyMethod.invoke ( null,
                                    hKey );
    ...
    private static void testKey ( int hive,
                                  String keyName,
                                  String valueName ) {
        String s;
