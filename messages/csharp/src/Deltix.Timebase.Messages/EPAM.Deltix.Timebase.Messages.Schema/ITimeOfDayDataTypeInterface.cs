...
namespace EPAM.Deltix.Timebase.Messages.Schema
{
    ...
    /// </summary>
    public interface ITimeOfDayDataTypeInterface : ITimeOfDayDataTypeInfo, IDataTypeInterface
    {
        ...
        /// </summary>
        new ITimeOfDayDataTypeInterface Clone();
        ...
        /// </summary>
        new ITimeOfDayDataTypeInterface CopyFrom(IRecordInfo source);
        
        /// <summary>
        /// Set null to all fields of this instance.
        /// <returns>this.</returns>
        /// </summary>
        new ITimeOfDayDataTypeInterface Nullify();
        
        /// <summary>
        /// Reset all instance field to their default states.
        /// <returns>this.</returns>
        /// </summary>
        new ITimeOfDayDataTypeInterface Reset();
        #endregion
    }
}