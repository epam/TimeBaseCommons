 ...
 */
@SchemaElement(
    name = "com.epam.deltix.timebase.messages.schema.NonStaticField",
    title = "NonStaticField"
)
public class NonStaticField extends Field implements RecordInterface {
  public static final String CLASS_NAME = NonStaticField.class.getName();

  /**
   * True, if field is defined as a primary key.
   * The property is applicable for unique streams only.
   */
   ...
   */
  @Override
  protected NonStaticField createInstance() {
    return new NonStaticField();
  }
   ...
   */
  @Override
  public NonStaticField clone() {
    NonStaticField t = createInstance();
    t.copyFrom(this);
    return t;
  }
   ...
   */
  @Override
  public NonStaticField copyFrom(RecordInfo template) {
    super.copyFrom(template);
    if (template instanceof NonStaticField) {
      NonStaticField t = (NonStaticField)template;
  ...
  public StringBuilder toString(StringBuilder str) {
    str.append("{ \"$type\":  \"NonStaticField\"");
    if (hasIsPrimaryKey()) {
